			...
			*/
			...
			const renderField = (desc) => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						desc.field === "provider" && directory.status === "ready" && !directory.credentialsChecked ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: "stp-hint",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					className: "stp-body",
					children: [
						modeDesc === void 0 ? null : renderToggle(modeDesc, modelMode ? void 0 : "已改用关键词规则：类型按关键词匹配得出、主题取首条消息原文，标题不会随对话更新。下面的分隔符与长度上限仍然有效。"),
