		...
		*/
		const FIELDS = [
			...
			},
			{
				field: "hiddenEnabled",
				label: "启用隐藏会话",
				hint: "打开后：侧边栏每条会话行悬停时，「…」左边会出现一只眼睛，点它就把这条会话隐藏起来（默认不再显示，随时可以再显示回来）；「工作区」那一行放大镜左边的眼睛是一键显示 / 收起所有被隐藏的会话。隐藏只影响侧边栏显不显示 —— 会话本身、搜索与标题自动生成都不受影响，也不会删掉任何东西。关掉这里，左侧这一整套按钮与隐藏效果全部停止执行；你设过的隐藏列表会原样保留，以后再打开还是那些会话被隐藏着。",
				spec: {
