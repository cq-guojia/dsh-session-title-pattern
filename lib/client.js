window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		const HIDDEN_ENABLED_HINT = "启用后，会话行悬停时行尾显示隐藏按钮，可将该会话从侧边栏隐藏；「工作区」标题行放大镜左侧的按钮用于整体显示或收起全部已隐藏的会话。隐藏仅影响侧边栏的呈现，不影响会话内容、搜索与标题生成，也不会删除任何数据。关闭后，上述按钮与隐藏效果均停止执行；已设置的隐藏列表将保留，重新启用时继续生效。";
		...
		*/
		function SettingsCard({ scope, describe, getLlm, getCredentials }) {
			...
			*/
			...
			/** `FIELDS` 里的开关字段。 */
			const renderToggle = (desc, notice) => {
				const { on, off } = desc.toggle ?? {
					on: "llm",
					off: "rules"
				};
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: "stp-hint",
							children: `当前已隐藏 ${hiddenCount} 条会话。隐藏仅影响侧边栏的呈现，不影响会话内容与搜索。`
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						visibleFields.filter((desc) => desc.field !== "mode").map((desc) => {
							if (desc.toggle !== void 0) return renderToggle(desc);
							return desc.field === "provider" && modelDesc !== void 0 ? renderModelPair(desc, modelDesc) : renderField(desc);
						}),
						renderHiddenToggle(),
