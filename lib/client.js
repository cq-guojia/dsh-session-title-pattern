		...
		*/
		async function loadDirectory(llm, describe, getCredentials) {
			try {
				...
				if (credentials !== void 0 && refs.length > 0) try {
				...
				for (const [provider, address] of addresses) {
					...
					const userConfigured = walk(view?.user, address.settingsPath) !== void 0;
					const ref = readApiKeyRef(view?.value, address.settingsPath);
					const credentialConfigured = ref !== void 0 && configuredRefs?.has(ref) === true;
			...
			const renderField = (desc) => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						desc.field === "mode" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						desc.field === "provider" && directory.status === "unavailable" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: "stp-hint",
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							children: isOpen ? "收起" : "展开"
						})
					})]
				}), isOpen ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: FIELDS.filter((desc) => desc.group === key).map(renderField) }) : null] }, key);
			};
