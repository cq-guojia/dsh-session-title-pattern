		...
		*/
		function SettingsCard({ scope, describe, getLlm, getCredentials }) {
			...
			*/
			...
			const renderToggle = (desc) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: "stp-field",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					className: "stp-body",
					children: [visibleFields.map((desc) => desc.field === "mode" ? renderToggle(desc) : renderField(desc)), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
